  ...
  return (
    <div className="App">
      ...
      <div className="container">
        ...
        <div className="consult">
          ...
          <div className="items">
            <div className="item">
              <h5>Виджеты</h5>
              <p className="vidjet">30 готовых решений</p>
            </div>
            <div className="item">
              <h5>Dashboard</h5>
              <p className="dashboard">с показателями вашего бизнеса</p>
            </div>
            <div className="item">
              <h5 className="skypeAudit">Skype Аудит</h5>
              <p className="skype">отдела продаж и CRM системы</p>
            </div>
            <div className="item">
              <h5>35 дней</h5>
              <p className="day">использования CRM</p>
            </div>
          </div>
      ...
      <footer className="footer">
        ...
        <div className="cases">
          <a href="#">Кейсы</a>
          <a href="#">Благотворительные письма</a>
          <a href="#">Сертификаты</a>
        ...
        <div className="contacts">
          ...
          <p className="street">Москва, Путевой проезд 3с1, к 902</p>
